...
function inject (bot, { version }) {
  ...
  function openChest (chestToOpen) {
    ...
    if (chestToOpen.constructor.name === 'Block') {
      assert.ok(chestToOpen.type === mcData.blocksByName['chest'].id || chestToOpen.type === mcData.blocksByName['ender_chest'].id || chestToOpen.type === mcData.blocksByName['trapped_chest'].id)
